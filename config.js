...
module.exports = {
    ...
    CAPTION: process.env.CAPTION || "POWERED BY GOOD MADARA",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE I'M GOOD MADARA 😊♻️",
    ...
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя sтαтυs sεεη נυsт ησω вү Itz tapas`",
